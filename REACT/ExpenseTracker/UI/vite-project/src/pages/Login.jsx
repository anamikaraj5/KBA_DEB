...
const Login = () => {
  ...
  return (
    <div>
        ...
        <div className="md:flex md:justify-center  gap-0 w-fit h-fit ml-[15px] mt-[100px] md:mt-[170px] md:ml-[540px] shadow-lg shadow-gray-800 overflow-hidden rounded-lg">
        ...
        {error && <p className='text-red-500 mb-4'>{error}</p>}
            <form onSubmit={handleLogin}>
                ...
                <button type="submit" className="bg-violet-900 text-white text-xl rounded-md h-[55px] w-[160px] mt-[60px] md:ml-[150px] ml-[100px]">Login</button>

                <div className="flex justify-between mt-[60px] mx-[20px]">
